...
async def save_file(media):
    ...
    try:
        ...
        logger.exception('Dosya veritabanına kaydedilirken hata oluştu')
    else:
        try:
            await file.commit()
        except DuplicateKeyError:
            logger.warning(media.file_name + " zaten veritabanına kaydedilmiş")
        else:
            logger.info(media.file_name + " veritabanına kaydedildi")
